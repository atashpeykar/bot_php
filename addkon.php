...
$Dev = 123456789; // <==== آیدی عددی مدیر ربات
$userbot = "نام کاربری ربات"; //<=== نام کاربری ربات
$userchanel = "نام کانال"; //<==== آی دی کاتال
...
//------------------------------------------
function SendMessage($chat_id, $text){//@bonabit
    Poker('sendMessage',[
        'chat_id'=>$chat_id,
        'text'=>$text,
        'parse_mode'=>'MarkDown']);
...
elseif($textmassage == "/start" && $tc == "private"){
    ...
    Poker('SendMessage',[
        'chat_id'=>$chat_id,
        'text'=>"😼👾سلام به ربات اد اجباری بناب ای تی خوش آمدید
...
🎃 فقط کافیه ربات را در گروهتان اد کرده و دستور /add را در گروهتان ارسال کنید و ربات را ادمین کنید...,",
    ...
    Poker('SendMessage',[
        'chat_id'=>$chat_id,
        'text'=>"😼👾به ربات رایگان اد کن بناب آی تی خوش آمدید
