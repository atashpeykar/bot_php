...
//-----------------------------------------
$Dev = 123456789;  //ایدی عددی ادمین
$channel = "ایدی کانال"; // ایدی کانال بدون @
//-----------------------------------------
define('API_KEY','توکن ربات'); // توکن ربات
//-----------------------------------------
...
[['text'=>"📢 کانال ما","url"=>"https://t.me/$channel"],['text'=>"👨‍💻 ارتباط با برنامه نویس","url"=>"https://t.me/Azarbinab"]],
],'resize_keyboard'=>true
]);
//-----------------------------------------
if($from_id != $Dev){
...
به ربات مترجم  بناب آی تی خوش اومدید ❄️

با استفاه از این ربات راحت یه مترجم همراه اشته باشید و همه جا ازش استفاده کنید 🌟

آی دی ربات جهت معرفی به دوستان خود

🤖 $botid
از دکمه های زیر استفاده کن 🔻",null, $message_id, $menu);
	$data['step'] = "none";
...
elseif ($text == "🔖 درباره ما"){
	SendMessage($chat_id,"این ربات توسط بناب آی تی ، ساخته شده است 📌

مدیریت ربات
@azarbinab 

📌لطفا جهت حمایت از ما ، ربات ما را به دوستان خود نیز معرفی نمایید",null, $message_id, $about);
$data['step'] = "none";
	file_put_contents("Data/$from_id/data.json",json_encode($data));
}
//-----------------------------------------
